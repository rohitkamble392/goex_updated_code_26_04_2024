        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" method="POST" action="{{ route('update-distributor') }}" >
                            @csrf
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <label for="name">{{ __('Name')}}<span class="text-red">*</span></label>
                                    <input type="text" name="name" class="form-control" value="{{ $distributor['Name'] }}">
                                    <input type="text" name="ID" id="ID" value="{{$distributor['ID']}}">
                                </div>
                                <div class="col-sm-4">
                                    <label for="mobileNo">{{ __('Mobile Number')}}<span class="text-red">*</span></label>
                                    <input type="number" name="mobileNo" class="form-control" value="{{$distributor['MobileNo']}}">
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <textarea type="text" name="address" class="form-control">{{$distributor['Address']}}</textarea>
                                </div>
                                <div class="col-sm-4">
                                    <label for="pincode">{{ __('PIN Code')}}<span class="text-red">*</span></label>
                                    <input type="number" name="pincode" class="form-control" value="{{$distributor['USerID']}}">
                                </div>
                            </div> 
                            <div class="form-group row">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" name="district" class="form-control" value="{{$distributor['District']}}">
                                </div>
                            </div> 
