<header class="header-top" header-theme="light">
    <div class="container-fluid">
        <div class="d-flex justify-content-between">
            ...
            <!-- <button type="button" class="btn btn-primary">Company Support Number : 7566879342</button>
            <button type="button" class="btn btn-primary">Distributor Support Number : 7566879342</button> -->
            <div class="top-menu d-flex align-items-center">
                <div class="dropdown">
