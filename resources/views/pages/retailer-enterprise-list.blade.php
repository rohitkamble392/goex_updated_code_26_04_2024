...
@section('title', 'Manage Retailer Enterprise')
@section('content')
@push('head')
...
<div class="container-fluid">
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5><b>{{ __('Manage Retailer Enterprise')}}</b></h5>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="row">
                <div class="col-sm-4">
                    <label for="retailerID"><b>{{ __('retailerID')}}</b></label>
                    <select name="retailerID" id="retailerID" class="form-control">
...
<script>
    $(document).ready(function() {
        ...
        function fetchData(retailerID) {
            $.ajax({
                url: '/manage-retailer-enterprise-details',
                type: 'POST',
                data: {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            response.data.forEach(function (item) {
                $('#retailerID').append('<option value="' + item.ID + '">' + item.Shop_Name + '</option>');
            });
        },
