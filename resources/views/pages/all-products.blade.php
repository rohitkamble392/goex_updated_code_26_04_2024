                        ...
                        <table id="simpletable" class="table table-striped table-hover">
                            <thead class="text-center bg-secondary">
                                <tr>
                                    ...
                                    <th class="text-white"><b>{{ __('Validity')}}</b></th>
                                    <th class="text-white"><b>{{ __('Claims')}}</b></th>
                                    <th class="text-white"><b>{{ __('Device Amount')}}</b></th>
                                    <th class="nosort text-white"><b>{{ __('Action')}}</b></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($productdetails['Result'] as $product)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="table-actions text-center">
                                            {{-- <button class="bg-secondary" type="button" data-toggle="modal" data-target="#demoModal" data-id="{{ $product['ID'] }}" data-name="{{ $product['Product_Name'] }}"><i class="ik ik-edit-2 text-white"></i></button> --}}
                                            <button class="bg-secondary" type="button" data-toggle="modal" data-target="#demoModal" data-id="{{ $product['ID'] }}" data-name="{{ $product['Product_Name'] }}" data-category="{{ $product['Category_Name'] }}" data-validity="{{ $product['Validity'] }}" data-claims="{{ $product['Claims'] }}" data-deviceamount="{{ $product['DeviceAmount'] }}"><i class="ik ik-edit-2 text-white"></i></button>
