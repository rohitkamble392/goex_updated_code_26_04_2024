...
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>{{ __('All Policies')}}</h5>
                            <span>{{ __('Create new Policy')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                        ...
                        <div class="dt-responsive">
                            <table id="all-policies"
                                ...
                                <tr>
                                    ...
                                    <th>{{ __('Policy Created At')}}</th>
                                    <th>{{ __('Policy Updated At')}}</th>
                                    <th>{{ __('Action')}}</th>
                                </tr>
                                </thead>
                            </table>
    ...
    <script>
        function confirmDelete(userId) {
            if (confirm('Are you sure you want to delete this Policy?')) {
                ...
                window.location.href = "{{ url('policy/delete') }}/" + userId;
            }
        }
    </script>
    ...
    <script src="{{ asset('js/all-feature-policies.js') }}"></script>
    @endpush
@endsection