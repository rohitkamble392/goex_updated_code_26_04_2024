...
class adddepartmentController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $departmentCounts = Employee::select('company_id', 'department')
            ...
            ->get()->where('company_id',$id);
        $data = Department::get()->where('company_id',$id);
        return view('pages.all-departments',compact('departmentCounts'));
    }
     ...
     */
     ...
     public function getdepartmentlist(Request $request): mixed
    {
    ...
    {
        $policyfeature = PolicyFeature::all();  
