            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 table-responsive">
                        <table class="table text-center text-hover text-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ __('175')}}</td>
                                    <td>{{ __('25')}}</td>
                                    <td><p class="bg-secondary" style="color:white;border-radius:10px;padding:2px;text-align:center;width:75%">10 Days Ago</p></td>
                                </tr>
                                <tr>
                                    <td>{{ __('102')}}</td>
