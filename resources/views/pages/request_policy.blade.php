...
@section('title', 'Request Policy Details')
@section('content')
            ...
            <div class="row align-items-end mb-5">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h4><b>{{ __('Request Policy Details')}}</b></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                        ...
                        <table id="data_table" class="table text-center table-hover table-striped">
                            <thead class="bg-secondary">
                                <tr>
                                    ...
                                    <th style="color: white">{{ __('Request Policy Date')}}</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            <a href="/edit-request-policy"><i class="ik ik-edit text-dark"></i></a>
