            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h4><b>{{ __('Manage Debit Report')}}</b></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                @endif
                    <div class="card-body">
                        <table id="data_table" class="table table-striped table-hover text-center">
                            ...
                            <tbody>
                                @foreach ($admindebitreport['Result'] as $admindebitreport)
                                <tr>
                                    <td class="text-center">{{ $admindebitreport['NumberofKey'] }}</td>
                                    <td class="text-center">{{ $admindebitreport['KeyType'] }}</td>
                                    <td class="text-center">{{ $admindebitreport['Req_Mode'] }}</td>
                                    <td class="text-center">{{ $admindebitreport['DebitBy'] }}</td>
                                    <td class="text-center">{{ $admindebitreport['CreditTo'] }}</td>
                                    <td class="text-center">{{ $admindebitreport['key_Rate'] }}</td>
                                    {{-- <td class="text-center">{{ $admincreditreport['Created_on'] }}</td> --}}
                                    <td class="text-center">{{ date('Y-m-d h:i:s A', strtotime($admindebitreport['Created_on'])) }}</td>
                                    <td>
