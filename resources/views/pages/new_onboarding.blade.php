...
@section('title', 'New On Boarding Details')
@section('content')
    ...
    @endpush
            ...
            <div class="row align-items-end mb-5">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h4><b>{{ __('New On Boarding Details')}}</b></h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="{{url('superadmin-dashboard')}}"><b><i class="ik ik-home"></i></b></a>
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <table id="data_table" class="table text-center table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            ...
                                            <a href="/edit-newonboarding"><i class="ik ik-edit text-dark"></i></a>
