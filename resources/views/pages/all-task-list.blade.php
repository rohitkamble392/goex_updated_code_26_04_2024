                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <button class="btn btn-secondary">
                                    <a href="create-task-list" class="text-white">{{ __('Create Task List')}}</a>
                                </button>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="card">
                        ...
                        <table id="data_table" class="table text-center">
                            <thead>
                                <tr>
                                    <th><b>{{ __('ID')}}</b></th>
                                    <th><b>{{ __('TicketReason')}}</b></th>
                                    <th><b>{{ __('CreatedOn')}}</b></th>
                                    <th class="nosort"><b>{{ __('Action')}}</b></th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($gettasklist['Result'] as $gettasklist)
                                <tr>
                                    <td>{{ $gettasklist['ID'] }}</td>
                                    <td>{{ $gettasklist['TicketReason'] }}</td>
                                    <td>{{ $gettasklist['CreatedOn'] }}</td>
                                    <td>
